  ...
  return (
    <>
      <SEOHead 
        ...
        description="Raspberry Pi security camera setup and Home Assistant integration: libcamera MJPEG streaming, RTSP fixes, Pi model comparison, motion alerts, local recording. Free."
