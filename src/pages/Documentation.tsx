  ...
  return (
    <>
      <SEOHead 
        ...
        description="Set up Raspberry Pi and IP cameras free: MJPEG and RTSP stream URLs, motion alerts, private local recording — no cloud uploads, no subscription fees."
